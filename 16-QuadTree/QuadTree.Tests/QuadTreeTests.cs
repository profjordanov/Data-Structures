...
namespace QuadTree.Tests
{
	...
	public class QuadTreeTests
	{
		...
		{
			quadTree = new QuadTree<TestBox>(WorldWidth, WorldHeight);
		}
		...
		public void Report_FromEmptyQuadrant_ShouldReturnEmpty()
		{
			...
			var elements = quadTree.Report(fourthQuadrant);
		...
		public void ForeachDfs_ShouldCorrectlyDisplayDepth()
		{
			...
			quadTree.ForEachDfs((elements, depth, quadrant) =>
			{
				Assert.AreEqual(quadTree.MaxDepth, depth);
			});
		}
